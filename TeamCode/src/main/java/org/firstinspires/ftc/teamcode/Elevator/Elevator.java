...
public class Elevator{
    ...
    public void IntakePowerSec(int secounds, double power){
        while (runtime.seconds() < secounds){
            intake.setPower(power);
        }
        intake.setPower(0);
    }
      ...
      public void daria(){
          ...
          AngleLift(657,-1);
          sleep(100);
          Elevator_function_down(720);
          IntakePower(2500,1);
          servo_left_and_right(1, .1);
          sleep(1000);

      }


    public void daria_thread(){
        ResetAngle();
        reset_all();
